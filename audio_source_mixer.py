...
class AudioSourceMixer(ThreadSource):
    ...
    def get_bytes(self, *args, **kwargs):
        ...
        # envoyer self.current_step_index à notre play_indicator
        if self.on_current_step_changed is not None:
            # Décallage de deux steps pour synchroniser l'affichage du step courant et le son entendu (à cause du buffer audio)
