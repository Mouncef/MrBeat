...
class SoundKit1(SoundKit):
    sounds = (
        Sound("assets/sounds/kit1/kick.wav", "KICK"),
        Sound("assets/sounds/kit1/clap.wav", "CLAP"),
        Sound("assets/sounds/kit1/shaker.wav", "SHAKER"),
        Sound("assets/sounds/kit1/snare.wav", "SNARE"),
    )
...
class SoundKitAll(SoundKit):
    sounds = (
        ...
        Sound("assets/sounds/kit1/shaker.wav", "SHAKER"),
        Sound("assets/sounds/kit1/snare.wav", "SNARE"),
        Sound("assets/sounds/kit1/bass.wav", "BASS"),
        Sound("assets/sounds/kit1/effects.wav", "EFFECTS"),
        Sound("assets/sounds/kit1/pluck.wav", "PLUCK"),
        Sound("assets/sounds/kit1/vocal_chop.wav", "VOCAL"),
    )
...
class SoundKit4(SoundKit):
    sounds = (Sound("assets/sounds/kit1/kick.wav", "KICK"),
              Sound("assets/sounds/kit1/clap.wav", "CLAP"),
              Sound("assets/sounds/kit1/shaker.wav", "SHAKER"),
              Sound("assets/sounds/kit1/snare.wav", "SNARE"),
              Sound("assets/sounds/kit1/pluck.wav", "PLUCK"),
